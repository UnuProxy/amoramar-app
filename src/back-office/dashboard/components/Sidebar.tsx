...
const LogoutButton = () => {
  ...
  return (
    <button
      ...
      className="w-full px-4 py-2.5 text-sm font-medium text-slate-700 hover:text-slate-900 hover:bg-sky-50 transition-all duration-150 flex items-center justify-center gap-2 rounded-lg border border-slate-200"
    >
...
export const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    <>
      ...
      <div
        className={cn(
          'bg-white h-screen border-r border-slate-200 fixed lg:sticky lg:top-0 z-[50] flex flex-col w-64 shadow-sm transform transition-all duration-200 lg:translate-x-0',
